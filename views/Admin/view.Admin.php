...
<div class="card shadow-lg mt-2">
    <div class="badge-primary card-header">
        <div class="row">
            ...
            <!-- <button type="submit" class="btn badge-info" style="display: none;"><i class="fa fa-save"></i></button> -->
        </div>
    </div>
                                ...
                                <form action="" id="form_editName" method="POST" style="display: none;">
                                    <div class="row pt-3">
                                        ...
                                        <div class="col-sm-4 col-lg-4">
                                            <input type="text" class="form-control" name="names" id="names" value="<?php $nombre_completo = $_SESSION['nombre_completo']; $nombre = explode(" ", $nombre_completo); echo " " . $nombre[0]; ?>">
                                        </div>
                                        <div class="col-sm-2 col-lg-2">
                                            <label class="pt-2" for="lastName">Apellidos</label>
                                        </div>
                                        <div class="col-sm-4 col-lg-4">
                                            <input type="text" class="form-control" name="lastName" id="lastName" value="<?php $nombre_completo = $_SESSION['nombre_completo']; $nombre = explode(" ", $nombre_completo); echo " " . $nombre[1]; ?>">
                                        </div>
        ...
        <div class="modal-content">
            ...
            <form action="" method="POST" id="form_Edit_Email">
                ...
                <div class="modal-footer">
                    ...
                    <!-- <a class="btn btn-primary text-light" id="chageEmag">Cambiar Correo</a> -->
                </div>
            </form>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#form_Edit_Password").on("submit", function() {
            ...
            formData.append('module', 'Admin');
            formData.append('controller', 'Admin');
            formData.append('nameFunction', 'editAcount');
            formData.append('email', $("#userId").val());
