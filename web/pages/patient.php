...
<head>
    ...
    <link rel="stylesheet" href="../../vendor/styles-js/css/form-validation.css">
    <!-- Custom styles for this template-->
    <!-- Popup-Box-CSS -->
    <link rel="stylesheet" href="../../vendor/styles-js/css/popuo-box.css" type="text/css" media="all" />
    <link href="../../vendor/sb-admin-2-2019/css/sb-admin.css" rel="stylesheet">
    <!-- MetisMenu CSS -->
...
<body class="bg-secondary">
    ...
    <script src="../../vendor/styles-js/js/form-validation.js"></script>
       <!-- LOG OUT -->
