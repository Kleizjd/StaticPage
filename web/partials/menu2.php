<aside class="left-sidebar">
    ...
    <div class="d-flex no-block nav-text-box align-items-center">
        ...
        <!-- <span><img src="../../public/img/favicon/logo-ferreteria.png" alt="JD DEVELOP" class="img-responsive" style="width: 50px;"></span> -->
        <span><img src="../../public/img/favicon/logo.png" alt="JD DEVELOP" class="img-responsive"></span>

        <a class="nav-lock waves-effect waves-dark ml-auto hidden-md-down" href="javascript:void(0)"><i class="mdi mdi-toggle-switch"></i></a>
        <!-- <a class="nav-lock waves-effect waves-dark ml-auto hidden-md-down" href="javascript:void(0)"><i class="fas fa-toggle-on"></i></a> -->
        <a class="nav-toggler waves-effect waves-dark ml-auto hidden-sm-up" href="javascript:void(0)"><i class="ti-menu ti-close"></i></a>

    </div>
    <!-- Sidebar scroll-->
    <div class="scroll-sidebar">
    <!-- <div class="scroll-sidebar ps-container ps-theme-default ps-active-y" data-ps-id="6fc58b1b-189e-718f-bf24-36abeb3d7512"> -->
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Dashboard
                            <span class="badge badge-pill badge-cyan">4</span></span></a>
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="index3.html">Demographical <i class="far fa-circle text-danger"></i></a>
                        </li>
                        <li><a href="index4.html">Modern <i class="far fa-circle text-warning"></i></a></li>
                        <li><a href="index5.html">Cryptocurrency <i class="far fa-circle text-primary"></i></a>
                        </li>
                    </ul>
                </li>
                <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-grid2"></i><span class="hide-menu">Apps</span></a>
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="app-contact-detail.html">Contact Detail <i class="ti-pencil-alt"></i></a>
                        </li>
                    </ul>
                </li>
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-palette"></i><span class="hide-menu">Ui Elements
                            <span class="badge badge-pill badge-primary text-white">25</span></span></a>
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="ui-tooltip-popover.html">Tooltip &amp; Popover <i class="ti-pin2"></i></a>
                        </li>
                        ...
                        <li><a href="ui-progressbar.html">Progressbar <i class="ti-layout-list-post"></i></a>
                        </li>
                        <li><a href="ui-nestable.html">Nestable <i class="ti-layout-accordion-separated"></i></a></li>
                        <li><a href="ui-range-slider.html">Range slider <i class="ti-layout-slider-alt"></i></a>
                        </li>
                        ...
                        <li><a href="ui-bootstrap-switch.html">Bootstrap Switch <i class="ti-flickr"></i></a>
                        </li>
                        ...
                        <li><a href="ui-date-paginator.html">Date-paginator <i class="icon-calender"></i></a>
                        </li>
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-media-right-alt"></i><span class="hide-menu">Forms</span></a>
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="form-dropzone.html">File Dropzone <i class="ti-layout-sidebar-2"></i></a>
                        </li>
                        ...
                        <li><a href="form-bootstrapwysihtml5.html">HTML5 Editor <i class="ti-html5"></i></a>
                        </li>
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-accordion-merged"></i><span class="hide-menu">Tables</span></a>
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="table-jsgrid.html">Js Grid Table <i class="ti-layout-placeholder"></i></a>
                        </li>
                        ...
                        <li><a href="table-editable-table.html">Editable Table <i class="ti-pencil-alt"></i></a>
                        </li>
                    </ul>
                </li>
                <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-settings"></i><span class="hide-menu">Widgets</span></a>
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="widget-charts.html">Charts Widgets <i class="ti-bar-chart-alt"></i></a>
                        </li>
                    </ul>
                </li>
                <li class="nav-small-cap"></li>
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-files"></i><span class="hide-menu">Sample Pages <span class="badge badge-pill badge-info">25</span></span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="starter-kit.html">Starter Kit <i class="ti-layout-width-default"></i></a>
                        </li>
                        ...
                        <li><a href="javascript:void(0)" class="has-arrow">Authentication <span class="badge badge-pill badge-success float-right">6</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="pages-login-2.html">Login 2 <i class="icon-user-following"></i></a>
                                </li>
                                <li><a href="pages-register.html">Register <i class="ti-marker-alt"></i></a>
                                </li>
                                <li><a href="pages-register2.html">Register 2 <i class="ti-marker"></i></a></li>
                                <li><a href="pages-register3.html">Register 3 <i class="ti-marker-alt"></i></a>
                                </li>
                                <li><a href="pages-lockscreen.html">Lockscreen <i class="icon-lock"></i></a>
                                </li>
                        ...
                        <li><a href="pages-utility-classes.html">Helper Classes <i class="icon-compass"></i></a>
                        </li>
                        <li><a href="pages-search-result.html">Search result <i class="icon-hourglass"></i></a>
                        </li>
                        ...
                        <li><a href="pages-lightbox-popup.html">Lighbox popup <i class="ti-light-bulb"></i></a>
                        </li>
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-pie-chart"></i><span class="hide-menu">Charts</span></a>
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="chart-chart-js.html">Chartjs <i class="mdi mdi-chart-areaspline"></i></a>
                        </li>
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-light-bulb"></i><span class="hide-menu">Icons</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="icon-material.html">Material Icons <i class="icon-social-reddit"></i></a>
                        </li>
